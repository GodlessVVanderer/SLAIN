...
struct AMFFactoryVtbl {
    ...
    create_component:
        unsafe extern "C" fn(*mut c_void, AMFContext, *const u16, *mut AMFComponent) -> AmfResult,
    ...
    load_external_component: unsafe extern "C" fn(
        *mut c_void,
        AMFContext,
        *const u16,
        *const u16,
...
struct AMFContextVtbl {
    ...
    get_property_at:
        unsafe extern "C" fn(*mut c_void, usize, *mut u16, usize, *mut c_void) -> AmfResult,
    ...
    alloc_surface:
        unsafe extern "C" fn(*mut c_void, i32, i32, i32, i32, *mut AMFSurface) -> AmfResult,
    ...
    create_buffer_from_host_native: unsafe extern "C" fn(
        *mut c_void,
        *mut c_void,
        usize,
        *mut AMFBuffer,
...
impl AmfDecoder {
    ...
    pub fn decode(&mut self, data: &[u8], pts: i64) -> Result<Option<DecodedFrame>, String> {
        unsafe {
            ...
            let result = ((*(*ctx).vtbl).alloc_buffer)(
                ctx as *mut c_void,
                AMF_MEMORY_HOST,
                data.len(),
                &mut buffer,
...
pub fn amf_supported_codecs(gpu_gen: String) -> Vec<String> {
    ...
    match gen {
        GpuGeneration::Vega | GpuGeneration::Navi | GpuGeneration::Navi2 | GpuGeneration::Navi3 => {
