...
impl PixelFormat {
    ...
    pub fn is_rgb(&self) -> bool {
        matches!(
            self,
            Self::RGB24 | Self::RGBA32 | Self::BGR24 | Self::BGRA32 | Self::R8G8B8A8
        )
    }
}
...
impl ColorSpace {
    ...
    pub fn yuv_to_rgb_matrix(&self) -> [[f32; 3]; 3] {
        ...
        [[1.0, 0.0, cr_r], [1.0, cb_g, cr_g], [1.0, cb_b, 0.0]]
    }
}
    ...
    fn nv12_to_rgba(&self, src: &VideoFrame, dst: &mut VideoFrame) {
        ...
        for y in 0..height {
            ...
            for x in 0..width {
                ...
                let g = (y_contrib + (self.u_table_g[u_val] >> 8) + (self.v_table_g[v_val] >> 8))
                    .clamp(0, 255) as u8;
