...
impl MessageBoard {
    ...
    pub fn list_threads(
        ...
        let threads = stmt
            .query_map(
                rusqlite::params![board_id, limit as i64, offset as i64],
                |row| {
    ...
    pub fn list_posts(
        ...
        let posts = stmt
            .query_map(
                rusqlite::params![thread_id, limit as i64, offset as i64],
                |row| {
    ...
    pub fn search(&self, query: &str, limit: usize) -> Result<Vec<Post>, String> {
        ...
        let posts = stmt
            .query_map(rusqlite::params![search_term, limit as i64], |row| {
                let attachments_str: String = row.get(12)?;
                let role_str: String = row.get(16)?;
...
mod tests {
    ...
    fn test_create_board() {
        ...
        // Create board
        let b = board
            .get_or_create_board("dQw4w9WgXcQ", "Test Video")
            .unwrap();
    ...
    fn test_create_thread_and_posts() {
        ...
        // Create thread
        let thread = board
            .create_thread(&b.id, "Test Thread", "Hello world!", vec![])
            .unwrap();
        ...
        // Create reply
        let post = board
            .create_post(&thread.id, "This is a reply", None, None)
            .unwrap();
