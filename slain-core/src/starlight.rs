...
impl FrequencySignature {
    ...
    pub fn derive_mandelbrot_c(&self) -> Complex {
        ...
        let mean: f64 = self.noise_samples.iter().sum::<f64>() / self.noise_samples.len() as f64;
...
impl StarlightSignature {
    ...
    pub fn from_spectral_data(
        ...
        let frequencies = spectral_bands
            .into_iter()
...
pub fn starlight_zoom_backward(
    c_re: f64,
    c_im: f64,
    z_re: f64,
    z_im: f64,
